...
INSERT INTO Atributo (nombre, tipo) VALUES ('numero de cartas', 'int'), ('primero', 'string'), ('tiempo', 'string');

INSERT INTO tiene (nombreJuego, nombreAtributo)
VALUES ('Hearthstone', 'numero de cartas'), ('Pokemon', 'primero'), ('Atletismo', 'tiempo');
...
INSERT INTO juega (nombreJugador, idPartida, puntuacion, fecha)
VALUES ('Lucia', 0, 1, '01/12/2017'), ('Lucia', 3, 0, '07/12/2017'), ('Lucia', 4, 2, '10/12/2017');
